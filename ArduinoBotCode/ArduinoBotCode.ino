...
*/         
      ...
      //{}
      //else if((int)c == 641)                                              //dpad up right on
      //{}
      //else if((int)c == 642)                                              //dpad up right off
      //{}
      //else if((int)c == 643)                                              //dpad right down on
      //{}
      //else if((int)c == 644)                                              //dpad right down off
      //{}
      //else if((int)c == 645)                                              //dpad down left on
      //{}  
      //else if((int)c == 646)                                              //dpad down left off
      //{}
      //else if((int)c == 647)                                              //dpad left up on
      //{}
      //else if((int)c == 648)                                              //dpad left up off
      //{}
      ...
      //{}
      //else if((int)c == 636)                                              //menu button off 
      //{}
